...
def send_mail(email, password, FROM, TO, msg):
    ...
    # in our case it's for Microsoft365, Outlook, Hotmail, and live.com, use google api for gmail
...
# your credentials
email = "TP072511@mail.apu.edu.my"
password = "Killer_Noob99"

# the sender's email
FROM = email
# the receiver's email
TO   = "merkkiller3@gmail.com"
